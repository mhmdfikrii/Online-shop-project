          ...
          <div class="flex font-sans">
            <div class="flex-none w-20 sm:w-40 relative">
              @php
                    ...
                    <img src="{{ asset($imageArray[0]) }}" alt="" class="absolute inset-0 w-20 sm:w-40 h-full object-cover" loading="lazy" />
                    @endif
            </div>
          ...
          <a href="/delete">
            <div class="absolute bottom-0 right-0 m-2">
              <form action="#" method="POST">
                ...
                <button
                  type="submit"
                  onclick="return confirm('Apakah Kamu Mau Menghapus Alamat Ini??')"
