@extends('layouts.main') {{-- Promo --}}
<section class="mt-7 sm:mt-20" id="promo">
  <div
    id="default-carousel"
...
<footer class="p-6 bg-gray-800 text-gray-100">
	...
	<div class="flex items-center justify-center px-6 pt-12 text-sm">
		<span class="text-gray-400">© Copyright 2024. All Rights Reserved.</span>
	</div>
</footer>